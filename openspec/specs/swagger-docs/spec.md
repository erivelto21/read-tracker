...
Defines the requirements for exposing interactive API documentation via Swagger UI (swaggo) in the tracker service. This capability covers how the UI is served, how metadata and endpoints are annotated, and how generated docs are managed in the repository and build workflow.
