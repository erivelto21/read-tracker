# Spec: Deployment Workflow

## Purpose

Defines the deployment workflow for the tracker stack after the Helm migration, including the supported Makefile targets for install, upgrade, and teardown of the Helm release.
